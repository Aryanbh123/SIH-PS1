...
// Worker Route wrapper to ensure context is loaded
const WorkerRouteWrapper = ({ children }) => {
  ...
  return (
    <WorkerRouteWrapper>
      <Routes>
        ...
        <Route path="/" element={<ProtectedRoute>{isWorker ? <WorkerLayout /> : <AppShell />}</ProtectedRoute>}>
          <Route index element={isWorker ? <WorkerDashboard /> : <Dashboard />} />
